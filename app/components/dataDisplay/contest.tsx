...
export const ContestDisplay = (UserHandle: {
  ...
  <div className="flex flex-col lg:flex-row justify-center">
    ...
    <div className="overflow-y-auto h-96 w-full lg:w-2/3 hide-scrollbar">
      <h2 className="text-lg md:text-3xl font-bold font-serif mb-6 text-black text-center lg:text-left">
        Contest History
      </h2>
      <div>
        <div className="space-y-4">
          <div className="w-full border border-gray-300 rounded-lg overflow-hidden">
            ...
            {data?.result.slice().reverse().map((contest: ContestResult) => (
              ...
              >
                ...
                <div className="hidden md:block flex-1 text-center">{contest.rank}</div>
                <div className="hidden md:block flex-1 text-center">
                  {contest.oldRating}
                </div>
                <div
    ...
    <div className="w-full lg:w-1/3 mt-6 lg:mt-0 lg:pl-6">
      <h1 className="text-2xl font-bold mb-3 text-[#c7a17e] font-serif text-center lg:text-left">
        Summary of your progress:
      </h1>
      <div className="w-full h-80 overflow-y-auto bg-neutral-50 text-sm md:text-lg text-slate-700 p-4 border border-gray-300 rounded-lg hover:shadow-2xl transition-shadow duration-300">
        {summary}
      </div>
    </div>
  </div>
